...
public class ExcelConverterTest {
    ...
    @Test
    void toExcelWithoutAnnotationsTest() {
        log.info("Init toExcelWithoutAnnotationsTest");

        final String sheetName = "My Sheet # 1";

        ToExcelConverter excel = Converter.toExcel();
        excel.sheet()
    ...
    @Test
    void toExcelWithMappingTest() {
        log.info("Init toExcelWithMappingTest");
    ...
    @Test
    void toExcelWithStyleTest() {
        log.info("Init toExcelWithStyleTest");
    ...
    @Test
    void toExcelWithAnnotationTest() {
        log.info("Init toExcelWithAnnotationTest");
