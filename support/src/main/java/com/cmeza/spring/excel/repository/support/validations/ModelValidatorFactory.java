...
public class ModelValidatorFactory {
    ...
    public <T> ModelConstraintViolation<T> makeConstraintViolation(javax.validation.ConstraintViolation<T> constraintViolation) {
    ...
    public <T> Set<ModelConstraintViolation<T>> makeJavaxConstraintViolation(Set<javax.validation.ConstraintViolation<T>> constraintViolations) {
